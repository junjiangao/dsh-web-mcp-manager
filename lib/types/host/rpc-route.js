 ...
 */
export function registerManagerRpcRoute(ctx, channel, dispatch) {
    const route = {
        kind: 'prefix',
        path: channel,
...
function endpointFrom(rawUrl, channel) {
    ...
    if (segments.some(segment => !ENDPOINT_SEGMENT_PATTERN.test(segment)))
        return undefined;
    return endpoint;
}
...
//# sourceMappingURL=rpc-route.js.map